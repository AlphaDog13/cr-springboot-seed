...
import static com.cyberunner.seed.common.utils.Constant.*;
...
public class CodeGenerator {
    ...
    public static void genCode(String... tableNames) {
        for (String tableName : tableNames) {
            genCodeByCustomModelName(tableName, null, 0);
        }
    }
     ...
     */
    public static void genCodeByCustomModelName(String tableName, String modelName, Integer flag) {
        genModelAndMapper(tableName, modelName, flag);
        if (0 == flag) {
    ...
    public static void genModelAndMapper(String tableName, String modelName, Integer flag) {
        ...
        modelPlugin.setConfigurationType("org.mybatis.generator.plugins.ToStringPlugin");
